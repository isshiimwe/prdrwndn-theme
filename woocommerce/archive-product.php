...
<div class="prdrwndn-shop-filters">
  <div class="prdrwndn-filter-inner">
    <a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>" class="prdrwndn-chip <?php echo ! $is_cat ? 'active' : ''; ?>">All</a>
    <?php foreach ( $cats as $cat ) : ?>
      <a href="<?php echo esc_url( get_term_link( $cat ) ); ?>" class="prdrwndn-chip <?php echo ( $is_cat && $current_cat->term_id === $cat->term_id ) ? 'active' : ''; ?>">
